...
Kuvassa \@ref(fig:CAmap1), ja tämä toimii aika mainiosti! Kuvan otsikko tulostuu kuvan alapuolelle, ehkä vähän huono idea?
...
```{r screeplot1, eval=FALSE, fig.cap="Dimensioiden", include=FALSE}
